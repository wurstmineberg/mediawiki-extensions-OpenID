...
$messages['af'] = array(
	...
	'openiderror' => 'Verifikasiefout', # Fuzzy
...
$messages['ast'] = array(
	...
	'openiderror' => "Error d'OpenID",
	'openid-error-openid-consumer-mode-disabled' => "Nun pue aniciar sesión con OpenID nesta wiki, porque'l mou de consumidor OpenID ta desactiváu.",
...
Nun podría aniciar sesión ensin una OpenID.',
	...
	'openid-show-openid-url-on-userpage-user' => "Amosar la URL de la so OpenID na páxina d'usuariu.",
	...
	'openid-provider-selection-button-login-or-create-account' => 'Aniciar sesión / crear cuenta con OpenID',
	'openid-provider-selection-button-login' => 'Aniciar sesión con OpenID',
	'openid-provider-selection-button-create-account' => 'Crear una cuenta con OpenID',
	'openid-provider-selection-button-convert' => 'Convertir o amestar OpenID',
	...
	'right-openid-login-with-openid' => 'Pue aniciar sesión con OpenID',
	'right-openid-create-account-with-openid' => 'Pue crear una cuenta con OpenID',
	'right-openid-create-account-without-openid' => 'Creación manual de cuenta ensin OpenID',
	...
	'action-openid-login-with-openid' => 'aniciar sesión con OpenID',
	'action-openid-create-account-with-openid' => 'crear una cuenta con OpenID',
	'action-openid-create-account-without-openid' => 'crear manualmente una cuenta, esto ye, ensin OpenID',
	...
	'openid-empty-param-error' => "Escriba'l so nome d'usuariu y, respeutivamente, la so URL d'OpenID.",
);
...
$messages['be-tarask'] = array(
	...
	'openiderror' => 'Памылка праверкі', # Fuzzy
...
$messages['bg'] = array(
	...
	'openiderror' => 'Грешка при потвърждението', # Fuzzy
...
$messages['bn'] = array(
	...
	'openiderror' => 'নিশ্চিতকরণ ত্রুটি', # Fuzzy
...
$messages['br'] = array(
	...
	'openiderror' => 'Fazi gwiriañ', # Fuzzy
...
$messages['bs'] = array(
	...
	'openiderror' => 'Greška pri provjeri', # Fuzzy
...
$messages['cs'] = array(
	...
	'openiderror' => 'Chyba při ověřování', # Fuzzy
...
Ohne OpenID könnten Sie sich nicht mehr anmelden.',
	...
	'prefs-openid-associated-openids' => 'Mit Ihrem „{{SITENAME}}“-Benutzerkonto verbundene OpenIDs:',
	'openid-userinfo-update-on-login-label' => 'Diese Benutzerprofilfelder werden vom OpenID-Konto jedes Mal automatisch aktualisiert, wenn Sie sich anmelden:',
	'openid-associated-openids-label' => 'Mit Ihrem Benutzerkonto verbundene OpenIDs:',
	'openid-add-url' => 'Eine neue OpenID Ihrem Benutzerkonto hinzufügen',
...
móžoš jadno ze slědujucych opcijow wubraś.',
	...
	'openid-convert-already-your-openid-text' => 'OpenID $1 jo južo z twójim kontom zwězany.',
...
$messages['el'] = array(
	...
	'openiderror' => 'Σφάλμα επαλήθευσης', # Fuzzy
...
$messages['eo'] = array(
	...
	'openiderror' => 'Atestada eraro', # Fuzzy
...
$messages['et'] = array(
	...
	'openid-convert-already-your-openid-text' => 'OpenID $1 on juba sinu kontoga seotud. Seda pole mõtet uuesti lisada.', # Fuzzy
 ...
 */
$messages['fa'] = array(
	'openid-desc' => 'اجازه دادن به ورود کاربران به ویکی با یک [//openid.net/ OpenID].
اگر این در ویکی فعال شده‌است، آنها همچنین می‌توانند از یوآر‌ال حساب کاربری خود در این ویکی به عنوان حساب کاربری برای ورود به حساب کاربری آگاه وب‌سایت‌های دیگر استفاده کنند.',
	...
	'openid-server-identity-page-text' => 'این یک صفحهٔ سرور ایجاد حساب کاربری فنی برای شروع اعتبارنامهٔ حساب کاربری است.
صفحه هیچ هدف دیگری ندارد.',
	'openidxrds' => 'پوشهٔ یادیس',
	'openidconvert' => 'مبدل ایجاد حساب',
	'openiderror' => 'خطا در ایجاد حساب کاربری',
	'openid-error-openid-consumer-mode-disabled' => 'شما نمی‌توانید با ایجاد حساب کاربری به این ویکی وارد شوید، زیرا حالت ایجاد حساب کاربری مصرف‌کننده غیرفعال شده‌است.',
	'openiderrortext' => 'خطایی زمان تأیید یوآر‌ال حساب کاربری رخ داد.',
	'openid-error-no-auth' => 'خطای اعتبارنامهٔ پاسخ/درخواست نامشخص، هنگام تأیید یوآر‌ال ایجاد حساب کاربری $1 رخ داد.',
	'openid-error-server-response' => "خطایی هنگام تأیید یوآر‌ال $1 رخ داد.
پاسخ سرود بود: ''$2''",
	'openid-error-request-forgery' => 'خطایی رخ داد: یک نماد نامعتبر پیدا شد.',
	'openid-error-wrong-force-provider-setting' => 'خطایی داخلی رخ داد:‌ مقدار یوآر‌ال نادرستی برای ارائه‌دهندهٔ اجباری "$1" پیدا شده‌است.',
	'openid-error-openid-convert-not-allowed-forced-provider' => 'امکان ارتباط بیشتر ایجاد حساب کاربری به حساب خود وجود ندارد، زیرا شما فقط می‌توانید از ارائه‌دهندهٔ  ایجاد حساب کاربری \'\'"اجبار شده"\'\' "$1" برای ورودها در این ویکی استفاده کنید.',
	'openidconfigerror' => 'خطای پیکربندی حساب کاربری',
	'openidconfigerrortext' => 'پیکربندی ذخیره‌سازی ایجاد حساب کاربری برای این ویکی، نامعتبر است.
لطفاً با یک [[Special:ListUsers/sysop|administrator]] مشورت کنید.',
	'openidpermission' => 'خطای مجوزهای ایجاد حساب',
	'openidpermissiontext' => 'حساب کابری که ایجاد کرده‌اید برای ورود به سرور مجاز نیست.',
	'openidcancel' => 'تأیید کنسل شده',
	'openidcanceltext' => 'تأیید یوآر‌ال ایجاد حساب کاربری لغو شد.',
	'openidfailure' => 'تأیید ناموفق',
	'openidfailuretext' => 'تأیید یوآر‌ال ایجاد حساب کاربری انجام نشد.
پیام خطا: "$1"',
	'openidsuccess' => 'تأیید موفق',
	'openidsuccesstext' => "'''تأیید موفق و ورود به عنوان کاربر $1'''.
حساب کاربری شما $2 است.
این و حساب‌های کاربری بیشتر اختیاری می‌تواند در [[Special:Preferences#mw-prefsection-openid|OpenID tab]] منابع شما اداره شود. <br /> رمز عبور حساب اختیاری می تواند در [[Special:Preferences#mw-prefsection-personal|User profile]] شما اضافه شود.",
	'openidusernameprefix' => 'کاربر حساب کاربری',
	'openidserverlogininstructions' => '$3 درخواست‌هایی که شما رمز عبور خود را برای کاربر $2 صفحهٔ $1 وارد می‌کنید (این یوآر‌ال حساب کاربری شما است)',
	'openidtrustinstructions' => 'اگر می‌خواهید اطلاعات را با $1 اشتراک‌گذاری کنید، بررسی کنید.',
	'openidallowtrust' => 'اجازه دادن $1 برای اعتماد کردن به این حساب کاربری.',
	'openidnopolicy' => 'سایت، خط‌‌مشی امنیتی را تعیین نکرده‌است.',
	'openidpolicy' => 'برای اطلاعات بیشتر <a target="_new" href="$1">privacy policy</a> را بررسی کنید.',
	...
	'openidchooseinstructions' => 'همهٔ کاربران به یک نام مستعار نیاز دارند؛
شما می‌توانید یکی از گزینه‌های زیر را انتخاب کنید.',
	'openidchoosenick' => 'نام مستعار شما ($1)',
	'openidchoosefull' => 'نام واقعی شما ($1)',
	'openidchooseurl' => 'نامی از حساب کاربری شما ($1) گرفته شده',
	'openidchooseauto' => 'یک نام ایجاد‌ شدهٔ خودکار ($1)',
	...
	'openidconvertinstructions' => 'این فرم به شما اجازه می‌دهد حساب کاربری خود را برای استفاده از یوآر‌ال حساب کاربری تغییر دهید یا یوآر‌ال‌های حساب کاربری بیشتری اضافه کنید',
	'openidconvertoraddmoreids' => 'تبدیل به حساب کاربری یا افزودن یوآر‌ال  حساب کاربری دیگری',
	'openidconvertsuccess' => 'با موفقیت تبدیل به حساب کاربری شد',
	'openidconvertsuccesstext' => 'شما با موفقیت حساب کاربری خود را به $1 تبدیل کردید.',
	'openid-convert-already-your-openid-text' => 'در حال حاضر حساب کاربری $1 با حساب شما مرتبط شده‌است.',
	'openid-convert-other-users-openid-text' => '$1 حساب کاربری کسی دیگر است.
شما نمی‌توانید از حساب کاربری کاربر دیگری استفاده کنید.',
	'openidalreadyloggedin' => 'شما هم‌اکنون وارد شده‌اید.',
	'openidalreadyloggedintext' => "'''شما قبلاً وارد شده‌اید، $1!'''
شما می‌توانید (مشاهده،حذف،افزودن بیشتر) حساب‌های کاربری در [[Special:Preferences#mw-prefsection-openid|OpenID tab]] ترجیحات خود اداره کنید.",
	'openidnousername' => 'هیچ نام کاربری تعیین نشده.',
	'openidbadusername' => 'نام کاربری بدی تعیین شده.',
	'openidautosubmit' => ' اگر شما جاوااسکریپت را فعال کرده‌باشید ،این صفحه شامل فرمی است که باید به طور خودکار ارائه شود.
اگر نه، دکمهٔ "ادامه" را امتحان کنید.',
	'openidclientonlytext' => 'شما نمی‌‌توانید از حساب‌های این ویکی برای ایجاد حساب کاربری در سایت دیگری استفاده کنید.',
	'openidloginlabel' => 'یوآرال حساب کاربری',
	'openidlogininstructions' => "{{SITENAME}} از [//openid.net/ OpenID] استاندارد برای ورود تنها بین وب‌سایت‌ها پشتیبانی‌ می‌کند.
ایجاد حساب کاربری به شما برای ورود به بسیاری از وب‌سایت‌های مختلف بدون استفاده از رمز عبور مختلف برای هریک اجازه می‌دهد.
( [//en.wikipedia.org/wiki/OpenID Wikipedia's OpenID article]برای اطلاعات بیشتر مشاهده کنید.)
بسیاری از [//openid.net/get/ ارائه‌دهندگان ایجاد حساب کاربری]، و شما ممکن است در حال حاضر یک حساب کاربری فعال شده در سرویس دیگری داشته باشید.",
	'openidlogininstructions-openidloginonly' => "{{SITENAME}} ''فقط'' به شما اجازه می‌دهد با حساب کاربری وارد شوید.",
	'openidlogininstructions-passwordloginallowed' => 'اگر شما در حال حاضر یک حساب در {{SITENAME}} دارید، شما می‌توانید [[Special:UserLogin|وارد شوید]] به  طور معمول با نام کاربری و رمز عبور.
برای استفادهٔ حساب کاربری در آینده،  شما می‌توانید [[Special:OpenIDConvert|تبدیل حساب خود به ایجاد حساب کاربری]] پس از اینکه به طور معمولی وارد شده‌اید.',
	'openidupdateuserinfo' => 'به‌ روز رسانی اطلاعات شخصی من:',
	'openiddelete' => 'حذف حساب کاربری',
	'openiddelete-text' => 'با کلیک کردن دکمهٔ "{{int:openiddelete-button}}"، شما حساب کاربری "$1" را از حساب خود حذف خواهید کرد.
شما دیگر قادر به ورود با این حساب کاربری نخواهید بود.',
	'openiddelete-button' => 'تأیید',
	'openiddeleteerrornopassword' => 'شما نمی توانید همهٔ حساب‌های کاربری خود را حذف کنید زیرا حساب شما هیچ رمز عبوری ندارد.
شما قادر به ورود بدون ایجاد یک حساب کاربری نخواهید بود.',
	'openiddeleteerroropenidonly' => 'شما نمی‌توانید همهٔ حساب‌های کاربری خود را حذف کنید زیرا شما فقط اجازه به ورود با حساب کاربری دارید.
شما قادر به ورود بدون ایجاد یک حساب کاربری نخواهید بود.',
	'openiddelete-success' => 'حساب کاربری با موفقیت از حساب شما حذف شده‌است.',
	'openiddelete-error' => 'خطایی هنگام حذف حساب کاربری از حساب شما رخ داد.',
	'openid-openids-were-not-merged' => 'حساب‌های کاربری هنگام ادغام حساب‌های کاربری، ادغام نشده‌بود.',
	'prefs-openid-show-openid' => 'یوآرال حساب کاربری در صفحهٔ کاربری',
	'prefs-openid-userinfo-update-on-login' => 'به روز رسانی اطلاعات حساب کاربری کاربر',
	'prefs-openid-associated-openids' => 'حساب کاربری شما برای ورود به {{SITENAME}}',
	'prefs-openid-trusted-sites' => 'سایت‌های قابل‌اعتماد',
	'prefs-openid-local-identity' => 'حساب کاربری شما برای ورود به سایت‌های دیگر',
	'openid-show-openid-url-on-userpage-user' => 'نمایش یو‌آر‌ال حساب کاربری شما بر روی صفحهٔ کاربریتان.',
	'openid-show-openid-url-on-userpage-always' => 'حساب کاربری شما همیشه در صفحهٔ کاربری شما هنگامی که از آن بازدید می‌کنید، نشان داده می‌شود.',
	'openid-show-openid-url-on-userpage-never' => 'حساب کاربری شما هرگز بر روی صفحه کاربریتان نشان داده نشده‌است.',
	'openid-userinfo-update-on-login-label' => 'زمینه‌های اطلاعات مشخصات کاربر که به طور خودکار از حساب کاربری شخصی هر زمان که وارد می‌شوید، به روز رسانی خواهد شد:',
	'openid-associated-openids-label' => 'حساب‌های کاربری با حساب شما مرتبط شده:',
	'openid-urls-url' => 'نشانی اینترنتی',
	'openid-urls-action' => 'اقدام',
	'openid-urls-registration' => 'زمان ثبت نام',
	'openid-urls-delete' => 'حذف',
	'openid-add-url' => 'اضافه کردن یک حساب کاربری به حساب خود',
	'openid-trusted-sites-label' => 'سایت‌هایی که شما اعتماد می‌کنید و جایی که شما از حساب کاربری خود برای ورود استفاده می‌کنید:',
	'openid-trusted-sites-table-header-column-url' => 'سایت‌های قابل‌اعتماد',
	'openid-trusted-sites-table-header-column-action' => 'فعالیت',
	'openid-trusted-sites-delete-link-action-text' => 'حذف',
	'openid-trusted-sites-delete-all-link-action-text' => 'حذف همهٔ سایت‌های قابل اعتماد',
	'openid-trusted-sites-delete-confirmation-page-title' => 'حذف سایت قابل اعتماد',
	'openid-trusted-sites-delete-confirmation-question' => 'با کلیک کردن دکمهٔ "{{int:openid-trusted-sites-delete-confirmation-button-text}}"، شما  "$1" را از فهرست سایت‌هایی که اعتماد کردید، حذف خواهید کرد.',
	'openid-trusted-sites-delete-all-confirmation-question' => 'با کلیک کردن دکمهٔ "{{int:openid-trusted-sites-delete-confirmation-button-text}}"، شما همهٔ سایت‌های مورد اعتماد را از مشخصات کاربری خود حذف خواهید‌کرد.',
	'openid-trusted-sites-delete-confirmation-button-text' => 'تأیید',
	'openid-trusted-sites-delete-confirmation-success-text' => '"$1" با موفقیت از فهرست سایت‌هایی که شما اعتماد کرده‌اید، حذف شد.',
	'openid-trusted-sites-delete-all-confirmation-success-text' => 'همهٔ سایت‌هایی که قبلاً اعتماد کردید با موفقیت از مشخصات کاربری شما حذف شدند.',
	'openid-local-identity' => 'حساب کاربری شما:',
	'openid-login-or-create-account' => 'وارد شوید یا حساب جدید ایجاد کنید',
	'openid-provider-label-openid' => 'وارد کردن یوآر‌ال حساب کاربری شما',
	...
	'openid-provider-label-aol' => 'اضافه کردن نام صفحهٔ ای‌اُال شما',
	'openid-provider-label-wmflabs' => 'ورود با استفاده از حساب دبلیو‌ام‌فلبز خود',
	'openid-provider-label-other-username' => 'نام کاربری $1 خود را وارد کنید',
	'openid-provider-selection-button-login-or-create-account' => 'ورود/ایجاد حساب با ایجاد حساب کاربری',
	...
	'action-openid-create-account-with-openid' => 'ایجاد یک حساب با ایجاد حساب کاربری',
	'action-openid-create-account-without-openid' => 'ایجاد دستی حساب کاربری یعنی بدون ایجاد حساب کاربری',
	'openid-dashboard-title' => 'داشبورد ایجاد حساب کاربری',
	'openid-dashboard-title-admin' => 'داشبورد ایجاد حساب کاربری (سرپرست)',
	'openid-dashboard-introduction' => 'تنظیمات گسترهٔ حساب کاربری فعلی ([$1 کمک])',
...
$messages['fi'] = array(
	...
	'openiderror' => 'Todennusvirhe', # Fuzzy
...
$messages['frp'] = array(
	...
	'openiderror' => 'Èrror de contrôlo', # Fuzzy
...
$messages['gl'] = array(
	...
	'openiderror' => 'Erro do OpenID',
	'openid-error-openid-consumer-mode-disabled' => 'Non pode acceder ao sistema co OpenID neste wiki, porque o modo de consumidor OpenID está desactivado.',
...
Non podería conectarse sen un OpenID.',
	...
	'openid-show-openid-url-on-userpage-user' => 'Mostrar o enderezo URL do seu OpenID na súa páxina de usuario.',
	...
	'openid-provider-selection-button-login-or-create-account' => 'Acceder ao sistema ou crear unha conta co OpenID',
	'openid-provider-selection-button-login' => 'Acceder ao sistema co OpenID',
	'openid-provider-selection-button-create-account' => 'Crear unha conta co OpenID',
	'openid-provider-selection-button-convert' => 'Converter ou engadir OpenID',
	...
	'right-openid-login-with-openid' => 'Pode acceder ao sistema co OpenID',
	'right-openid-create-account-with-openid' => 'Pode crear unha conta co OpenID',
	'right-openid-create-account-without-openid' => 'Creación manual de contas sen o OpenID',
	...
	'action-openid-login-with-openid' => 'acceder ao sistema co OpenID',
	'action-openid-create-account-with-openid' => 'crear unha conta co OpenID',
	'action-openid-create-account-without-openid' => 'crear manualmente unha conta, sen o OpenID',
	...
	'openid-empty-param-error' => 'Escriba o seu nome de usuario e o enderezo URL do seu OpenID.',
);
...
$messages['gsw'] = array(
	...
	'openidxrds' => 'Yadis-Datei',
	'openidconvert' => 'OpenID-Konverter',
	'openiderror' => 'Iberpriefigsfähler', # Fuzzy
...
$messages['hi'] = array(
	...
	'openiderror' => 'प्रमाणिकरण गलती', # Fuzzy
...
Faktulatiwne hesło hodźi so w twojim [[Special:Preferences#mw-prefsection-personal|wužiwarskim profilu]] přidać.",
	...
	'openid-convert-already-your-openid-text' => 'OpenID $1 je hižo z twojim kontom zwjazany.',
...
Ty njemóhł so bjez OpenID přizjewić.',
	...
	'openid-show-openid-url-on-userpage-user' => 'Twój URL OpenID na twojej wužiwarskej stronje pokazać',
	...
	'openid-trusted-sites-delete-confirmation-page-title' => 'Zhašenje dowěryhódnych sydłow',
	...
	'openid-provider-selection-button-login-or-create-account' => 'Z OpenID přizjewić/konto załožić',
	'openid-provider-selection-button-login' => 'Z OpenID přizjewić',
	'openid-provider-selection-button-create-account' => 'Z OpenID konto załožić',
	'openid-provider-selection-button-convert' => 'OpenID konwertować abo přidać',
	...
	'right-openid-login-with-openid' => 'Z OpenID přizjewić',
	'right-openid-create-account-with-openid' => 'Z OpenID konto załožić',
	'right-openid-create-account-without-openid' => 'Manuelne załoženje konta bjez OpenID',
...
$messages['hu'] = array(
	...
	'openidconvert' => 'OpenID konverter',
	'openiderror' => 'Hiba az ellenőrzés során', # Fuzzy
...
$messages['id'] = array(
	...
	'openiderror' => 'Verifikasi gagal', # Fuzzy
...
$messages['it'] = array(
	...
	'openid-identifier-page-text-different-user' => "Questa pagina è l'identificatore per utente con ID $1.",
	'openid-identifier-page-text-no-such-local-openid' => 'Questo è un identificatore OpenID locale non valido.',
	'openidxrds' => 'file Yadis',
	'openidconvert' => 'convertitore OpenID',
	'openiderror' => 'Errore OpenID',
...
Non saresti in grado di accedere senza un OpenID.',
	...
	'openid-provider-label-wmflabs' => 'Accedi utilizzando il tuo account Wmflabs',
	'openid-provider-label-other-username' => 'Inserisci il tuo $1 nome utente',
	'openid-provider-selection-button-login-or-create-account' => 'Entra / crea account con OpenID',
	'openid-provider-selection-button-login' => 'Accedi con OpenID',
	'openid-provider-selection-button-create-account' => "Crea un'utenza con OpenID",
	'openid-provider-selection-button-convert' => 'Converti o aggiungi OpenID',
	...
	'right-openid-login-with-openid' => 'Può accedere con OpenID',
	'right-openid-create-account-with-openid' => "Può creare un'utenza con OpenID",
	'right-openid-create-account-without-openid' => "Crea manualmente un'utenza senza OpenID",
	'action-openid-converter-access' => 'aggiungere o convertire il tuo account per usare identità OpenID',
	'action-openid-dashboard-access' => 'accedere al cruscotto OpenID',
	'action-openid-dashboard-admin' => 'accedere al cruscotto amministrativo OpenID',
	'action-openid-login-with-openid' => 'accedere con OpenID',
	'action-openid-create-account-with-openid' => "creare un'utenza con OpenID",
	'action-openid-create-account-without-openid' => "creare manualmente un'utenza senza OpenID",
...
ログインに OpenID が必要です。',
	...
	'openid-show-openid-url-on-userpage-user' => '自分の利用者ページに OpenID URL を表示する。',
...
$messages['jv'] = array(
	'openidxrds' => 'Berkas Yadis',
	'openiderror' => 'Kaluputan vérifikasi', # Fuzzy
...
$messages['ka'] = array(
	...
	'openiderror' => 'დადასტურების შეცდომა', # Fuzzy
...
თქვენ შეგიძლიათ აირჩიოთ ქვემოთ მოცემულიდან ერთ-ერთი.',
	...
	'openid-convert-already-your-openid-text' => 'OpenID $1 უკვე დაკავშირებულია თქვენ ანგარიშთან. მისი ხელმეორედ დამატება უაზროა.', # Fuzzy
...
$messages['km'] = array(
	...
	'openiderror' => 'កំហុស​ក្នុងការផ្ទៀងផ្ទាត់', # Fuzzy
...
또한 위키의 사용자 계정을 통해 OpenID를 지원하는 다른 사이트에도 로그인할 수 있습니다',
	...
	'openid-error-openid-consumer-mode-disabled' => 'OpenID 컨슈머 모드가 비활성화되어 있으므로 OpenID로 이 위키에 로그인할 수 없습니다.',
...
OpenID 없이 로그인 할 수 없습니다.',
	...
	'openid-provider-selection-button-login-or-create-account' => 'OpenID로 계정 로그인/만들기',
	'openid-provider-selection-button-login' => 'OpenID로 로그인',
	'openid-provider-selection-button-create-account' => 'OpenID로 계정 만들기',
	'openid-provider-selection-button-convert' => 'OpenID 변환 또는 추가',
	...
	'right-openid-login-with-openid' => 'OpenID로 로그인 할 수 있음',
	'right-openid-create-account-with-openid' => 'OpenID로 계정 만들 수 있음',
	'right-openid-create-account-without-openid' => 'OpenID 없이 수동으로 계정 만들기',
	...
	'action-openid-login-with-openid' => 'OpenID로 로그인하기',
	'action-openid-create-account-with-openid' => 'OpenID로 계정 만들기',
	'action-openid-create-account-without-openid' => 'OpenID 없이 수동으로 계정 만들기',
	...
	'openid-empty-param-error' => '각각의 OpenID URL에 당신의 사용자 이름을 넣어주세요.',
);
...
$messages['ksh'] = array(
	...
	'openiderror' => 'Fähler beim Pröfe', # Fuzzy
...
Dir kéint Iech ouni OpenID net aloggen.',
	...
	'openid-add-url' => 'Eng nei OpenID bei Äre Benotzerkont derbäisetzen',
 ...
 */
$messages['lt'] = array(
	'openiderror' => 'Tikrinimo klaida', # Fuzzy
...
Ако немате OpenID нема да можете да се најавите.',
	...
	'prefs-openid-show-openid' => 'OpenID-URL на корисничката страница.',
	...
	'openid-show-openid-url-on-userpage-user' => 'Прикажи OpenID-URL на корисничката страница.',
...
$messages['mr'] = array(
	...
	'openiderror' => 'तपासणी त्रुटी', # Fuzzy
...
$messages['ms'] = array(
	...
	'openiderror' => 'Ralat pengesahan', # Fuzzy
...
anda boleh memilih satu daripada pilihan-pilihan berikut.',
	...
	'openid-convert-already-your-openid-text' => 'OpenID $1 sudah dikaitkan dengan akaun anda. Tiada perlunya menambahkannya semula.', # Fuzzy
...
$messages['nb'] = array(
	...
	'openiderror' => 'Bekreftelsesfeil', # Fuzzy
...
$messages['nl'] = array(
	...
	'openiderror' => 'OpenID-fout',
	'openid-error-openid-consumer-mode-disabled' => 'U kunt niet aanmelden met OpenID bij deze wiki, omdat aanmelden via OpenID is uitgeschakeld.',
	'openiderrortext' => 'Er is een fout opgetreden tijdens de verificatie van de OpenID URL.',
	'openid-error-no-auth' => 'Er is een niet-gespecificeerde fout opgetreden in het proces van verzoek en antwoord tijdens de controle van de OpenID-URL $1.',
	'openid-error-server-response' => 'Er is een fout opgetreden tijdens de controle van de OpenID-URL $1.

Het antwoord van de server was: <strong>$2</strong>',
	...
	'openid-error-openid-convert-not-allowed-forced-provider' => 'Het is niet mogelijk meer OpenID\'s te koppelen aan uw gebruiker omdat u aleen de <em>"verplichte"</em> OpenID-provider "$1" kunt gebruiken voor deze wiki.',
...
Optioneel kunt u een wachtwoord instellen voor deze gebruiker in uw [[Special:Preferences#mw-prefsection-personal|gebruikersprofiel]].",
	...
	'openid-convert-already-your-openid-text' => 'Het OpenID $1 is al gekoppeld aan uw gebruiker.',
...
Dan zou u niet langer kunnen aanmelden zonder een OpenID.",
	...
	'openid-show-openid-url-on-userpage-user' => 'Uw OpenID-URL weergeven op uw gebruikerspagina.',
	...
	'openid-provider-selection-button-login-or-create-account' => 'Aanmelden / registreren met OpenID',
	'openid-provider-selection-button-login' => 'Aanmelden met OpenID',
	'openid-provider-selection-button-create-account' => 'Gebruiker aanmaken met OpenID',
	'openid-provider-selection-button-convert' => 'OpenID converteren of toevoegen',
	...
	'right-openid-login-with-openid' => 'Kan aanmelden met OpenID',
	'right-openid-create-account-with-openid' => 'Kan een gebruiker aanmaken met OpenID',
	'right-openid-create-account-without-openid' => 'Kan handmatig gebruikers aanmaken zonder OpenID',
	...
	'action-openid-login-with-openid' => 'aan te melden met OpenID',
	'action-openid-create-account-with-openid' => 'een gebruiker aan te maken met OpenID',
	'action-openid-create-account-without-openid' => 'handmatig een gebruiker aan te maken zonder OpenID',
	'openid-dashboard-title' => 'OpenID-dashboard',
	...
	'openid-empty-param-error' => 'Vul uw gebruikersnaam of uw OpenID-URL in.',
);
...
$messages['nn'] = array(
	...
	'openidxrds' => 'Yadis-fil',
	'openidconvert' => 'OpenID-konvertering',
	'openiderror' => 'Feil under stadfesting', # Fuzzy
...
Nie będziesz mógł się zalogować bez OpenID.',
	...
	'openid-trusted-sites-table-header-column-url' => 'Zaufane witryny',
...
$messages['pms'] = array(
	...
	'openidconvert' => 'Convertidor OpenID',
	'openiderror' => 'Eror ëd verìfica', # Fuzzy
...
$messages['pt'] = array(
	...
	'openiderror' => 'Erro de verificação', # Fuzzy
...
Você não poderia entrar sem um OpenID.',
	...
	'prefs-openid-show-openid' => 'URL de OpenID em sua página de usuário',
...
$messages['ro'] = array(
	...
	'openiderror' => 'Eroare de verificare', # Fuzzy
...
У вас не будет возможности войти в систему без OpenID.',
	...
	'prefs-openid-userinfo-update-on-login' => 'Обновление OpenID-информации пользователя',
	'prefs-openid-associated-openids' => 'Ваши OpenID для входа на {{SITENAME}}',
	...
	'openid-trusted-sites-label' => 'Сайты, которым вы доверяете и на которых вы использовали ваш OpenID для входа в систему:',
...
$messages['scn'] = array(
	...
	'openiderror' => 'Sbàgghiu di virìfica', # Fuzzy
...
$messages['si'] = array(
	...
	'openiderror' => 'සත්‍යාපන දෝෂය', # Fuzzy
...
$messages['sk'] = array(
	...
	'openidconvert' => 'OpenID konvertor',
	'openiderror' => 'Chyba pri overovaní', # Fuzzy
...
$messages['sr-el'] = array(
	'openidserver' => 'OpenID server',
	'openidconvert' => 'OpenID konvertor',
	'openiderror' => 'Greška prilikom verifikacije', # Fuzzy
...
$messages['stq'] = array(
	...
	'openidconvert' => 'OpenID-Konverter',
	'openiderror' => 'Wröige-Failer', # Fuzzy
...
Du skulle inte kunna logga in utan ett OpenID.',
	...
	'openid-show-openid-url-on-userpage-user' => 'Visa din OpenID-webbadress på din användarsida.',
	...
	'openid-provider-selection-button-login-or-create-account' => 'Logga in / skapa konto med OpenID',
	'openid-provider-selection-button-login' => 'Logga in med OpenID',
	'openid-provider-selection-button-create-account' => 'Skapa konto med OpenID',
	'openid-provider-selection-button-convert' => 'Konvertera eller lägg till OpenID',
	...
	'right-openid-login-with-openid' => 'Kan logga in med OpenID',
	'right-openid-create-account-with-openid' => 'Kan skapa konto med OpenID',
	'right-openid-create-account-without-openid' => 'Manuellt kontoskapande utan OpenID',
	'action-openid-converter-access' => 'lägga till eller konvertera dina konton för att använda OpenID-identiteter',
	'action-openid-dashboard-access' => 'komma åt instrumentpanelen för OpenID',
	'action-openid-dashboard-admin' => 'komma åt OpenID-instrumentpanelen för administratörer',
	'action-openid-login-with-openid' => 'logga in med OpenID',
	'action-openid-create-account-with-openid' => 'skapa ett konto med OpenID',
	'action-openid-create-account-without-openid' => 'skapa manuellt ett konto, d.v.s. utan OpenID',
	...
	'openid-empty-param-error' => 'Var god fyll i ditt användarnamn samt din OpenID-webbadress.',
);
...
$messages['tg-cyrl'] = array(
	...
	'openiderror' => 'Хатои тасдиқ', # Fuzzy
...
$messages['tg-latn'] = array(
	...
	'openiderror' => 'Xatoi tasdiq', # Fuzzy
...
$messages['tl'] = array(
	...
	'openiderror' => 'Kamalian sa pagpapatunay', # Fuzzy
...
$messages['tr'] = array(
	...
	'openiderror' => 'Doğrulama hatası', # Fuzzy
...
У вас не буде можливості увійти в ситему без OpenID.',
	...
	'openid-show-openid-url-on-userpage-user' => 'Показати OpenID URL на вашу сторінку користувача.',
	...
	'openid-empty-param-error' => "Будь ласка, заповніть ваше ім'я користувача відповідно OpenID URL.",
);
 ...
 */
$messages['ur'] = array(
	'openiderror' => 'تصدیق کی غلطی', # Fuzzy
...
$messages['vec'] = array(
	...
	'openidxrds' => 'file Yadis',
	'openidconvert' => 'convertidor OpenID',
	'openiderror' => 'Eròr ne la verifica', # Fuzzy
...
$messages['vep'] = array(
	...
	'openiderror' => 'Verifikacijan petuz', # Fuzzy
...
$messages['vi'] = array(
	...
	'openididentifier' => 'Định danh OpenID',
	'openidlogin' => 'Đăng nhập / mở tài khoản dùng OpenID',
	'openidserver' => 'Dịch vụ OpenID',
	'openid-identifier-page-text-user' => 'Trang này là định danh của người dùng “$1”.',
	'openid-identifier-page-text-different-user' => 'Trang này là định danh của người dùng số $1.',
	'openid-identifier-page-text-no-such-local-openid' => 'Đây là một định danh OpenID địa phương không hợp lệ.',
	'openid-server-identity-page-text' => 'Đây là một trang hệ thống của trình chủ OpenID để bắt đầu quá trình xác minh OpenID.
Trang này không có mục đích khác.',
	'openidxrds' => 'Tập tin Yadis',
	'openidconvert' => 'Chuyển đổi OpenID',
	'openiderror' => 'Lỗi OpenID',
...
Bạn sẽ không đăng nhập được dùng OpenID này.',
	...
	'prefs-openid-userinfo-update-on-login' => 'Cập nhật thông tin cá nhân OpenID',
	'prefs-openid-associated-openids' => 'Các OpenID của bạn để đăng nhập vào {{SITENAME}}',
	'prefs-openid-trusted-sites' => 'Trang được tin cậy',
	'prefs-openid-local-identity' => 'OpenID của bạn để đăng nhập vào các trang khác',
	...
	'openid-trusted-sites-table-header-column-url' => 'Trang được tin cậy',
	'openid-trusted-sites-table-header-column-action' => 'Tác vụ',
	'openid-trusted-sites-delete-link-action-text' => 'Xóa',
	'openid-trusted-sites-delete-all-link-action-text' => 'Xóa tất cả các trang được tin cậy',
	'openid-trusted-sites-delete-confirmation-page-title' => 'Xóa trang được tin cậy',
	'openid-trusted-sites-delete-confirmation-button-text' => 'Xác nhận',
	'openid-local-identity' => 'OpenID của bạn:',
	...
	'openid-provider-label-wmflabs' => 'Đăng nhập qua tài khoản Wmflabs của bạn',
	'openid-provider-label-other-username' => 'Nhập tên đăng nhập $1',
	'openid-provider-selection-button-login-or-create-account' => 'Đăng nhập / mở tài khoản qua OpenID',
	'openid-provider-selection-button-login' => 'Đăng nhập qua OpenID',
	'openid-provider-selection-button-create-account' => 'Mở tài khoản qua OpenID',
	'openid-provider-selection-button-convert' => 'Chuyển đổi hoặc thêm OpenID',
	...
	'right-openid-login-with-openid' => 'Đăng nhập qua OpenID',
	'right-openid-create-account-with-openid' => 'Mở tài khoản qua OpenID',
	'right-openid-create-account-without-openid' => 'Mở tài khoản thủ công không có OpenID',
	'action-openid-converter-access' => 'thêm hoặc chuyển đổi tài khoản của bạn để sử dụng danh tính OpenID',
	'action-openid-dashboard-access' => 'truy cập vào bảng điều khiển OpenID',
	'action-openid-dashboard-admin' => 'truy cập vào bảng điều khiển người quản lý OpenID',
	'action-openid-login-with-openid' => 'đăng nhập qua OpenID',
	'action-openid-create-account-with-openid' => 'mở tài khoản qua OpenID',
	'action-openid-create-account-without-openid' => 'mở tài khoản thủ công, chẳng hạn không có OpenID',
...
$messages['vo'] = array(
	...
	'openiderror' => 'Kontrolamapöl', # Fuzzy
...
$messages['zh-hans'] = array(
	...
	'openididentifier' => 'OpenID标识符',
	'openidlogin' => '使用OpenID登录或创建账号',
	'openidserver' => 'OpenID服务器',
	'openid-identifier-page-text-user' => '此页面是用户“$1”的标识符。',
	'openid-identifier-page-text-different-user' => '此页面是用户ID $1的标识符。',
...
您可以从下面任选一个。',
	...
	'openidchooseexisting' => '本wiki上的已有账户',
	...
	'openid-convert-already-your-openid-text' => 'OpenID$1已经关联至你的账户。',
...
没有OpenID您将无法登录。',
	...
	'openid-show-openid-url-on-userpage-user' => '在你的用户页显示你的OpenID URL。',
	...
	'openid-provider-selection-button-login-or-create-account' => '登录/创建账户（使用OpenID）',
	'openid-provider-selection-button-login' => '使用OpenID登录',
	'openid-provider-selection-button-create-account' => '使用OpenID创建账户',
	'openid-provider-selection-button-convert' => '转换或添加OpenID',
	...
	'right-openid-login-with-openid' => '可以使用OpenID登录',
	'right-openid-create-account-with-openid' => '可以使用OpenID创建账户',
	'right-openid-create-account-without-openid' => '不用OpenID，手动创建账户',
	...
	'action-openid-login-with-openid' => '使用OpenID登录',
	'action-openid-create-account-with-openid' => '使用OpenID创建一个账户',
	'action-openid-create-account-without-openid' => '手动创建一个账户，例如不用OpenID',
	...
	'openid-empty-param-error' => '请分别填写你的用户名和你的OpenID URL。',
);
