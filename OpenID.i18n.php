...
You would not able to log in without an OpenID.',
	...
	'openid-trusted-sites' => 'Sites you trust and where you have used your OpenID for logging in:',
...
Nun podría aniciar sesión ensin una OpenID.',
	'openiddelete-sucess' => 'La OpenID desaniciose correutamente de la to cuenta.',
	...
	'openid-prefstext' => 'Preferencies de [//openid.net/ OpenID]',
	'openid-pref-hide' => "Anubrir la URL de la so OpenID na páxina d'usuariu, si anicia sesión con OpenID.",
	'openid-pref-update-userinfo-on-login' => "Anovar la siguiente información de la persona OpenID cada vez qu'anicie sesión:",
	...
	'openid-trusted-sites' => "Sitios nos que tien enfotu y onde yá utilizó la so OpenID p'aniciar sesión:",
...
Ohne OpenID könntest du dich nicht mehr anmelden.',
	...
	'openid-trusted-sites' => 'Websites, denen du vertraust, und bei denen du mit deiner OpenID bekannt bist:',
...
Vous ne pourriez pas vous connecter sans un OpenID.",
	...
	'openid-trusted-sites' => 'Sites en qui vous avez confiance et où vous avez utilisé votre OpenID pour vous connecter:',
...
Vos pouede administrar (vêre, suprimar et pués nen apondre d’ôtres) OpenIDs dedens l’[[Special:Preferences#mw-prefsection-openid|ongllèta OpenID]] de voutres prèferences.",
	...
	'openiddelete-button' => 'Confirmar',
	'openid-prefstext' => 'Prèferences de [//openid.net/ OpenID]',
	'openid-pref-hide' => 'Cachiér voutron OpenID sur voutra pâge utilisator, se vos vos branchiéd avouéc OpenID.',
	'openid-pref-update-userinfo-on-login' => 'Betar a jorn cetes enformacions dês OpenID a tôs los côps que mè brancho :',
	'openid-urls-desc' => 'OpenID associyêyes avouéc voutron compto :',
	'openid-urls-url' => 'URL',
...
Non podería conectarse sen un OpenID.',
	...
	'openid-urls-delete' => 'Borrar',
	'openid-trusted-sites' => 'Sitios nos que confía e nos que utilizou o seu OpenID para identificarse:',
...
Ty njemóhł so bjez OpenID přizjewić.',
	...
	'openid-trusted-sites' => 'Sydła, kotrymž dowěrješ a hdźež sy swój OpenID za přizjewjenje wužił:',
...
Ако немате OpenID нема да можете да се најавите.',
	...
	'openid-trusted-sites' => 'Мрежните места на коишто им верувате и кајшто го имате користено вашиот OpenID за најава:',
