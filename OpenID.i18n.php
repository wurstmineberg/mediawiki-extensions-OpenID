...
Vous ne pourriez pas vous connecter sans un OpenID.",
	...
	'openid-hide-openid-label' => 'Cacher votre OpenID sur votre page utilisateur, si vous vous connectez avec OpenID.', # Fuzzy
...
Non podería conectarse sen un OpenID.',
	...
	'openid-hide-openid-label' => 'Agoche o enderezo URL do seu OpenID na súa páxina de usuario, se accede ao sistema con OpenID.', # Fuzzy
...
ログインに OpenID が必要です。',
	...
	'openid-hide-openid-label' => 'OpenID でログインしている場合に、OpenID を利用者ページに表示しない', # Fuzzy
...
OpenID 없이 로그인 할 수 없습니다.',
	...
	'openid-hide-openid-label' => 'OpenID로 로그인하면 사용자 문서에 OpenID URL을 숨깁니다.', # Fuzzy
	...
	'openid-trusted-sites-delete-confirmation-page-title' => '신뢰하는 사이트 삭제',
...
Ако немате OpenID нема да можете да се најавите.',
	...
	'openid-hide-openid-label' => 'Скријте ја вашата OpenID URL адреса на вашата корисничката страница, ако се најавувате со OpenID.', # Fuzzy
...
Brez OpenID se ne boste mogli prijaviti.',
	...
	'openid-hide-openid-label' => 'Skrijte svoj URL OpenID na svoji uporabniški strani, če se prijavite z OpenID.', # Fuzzy
