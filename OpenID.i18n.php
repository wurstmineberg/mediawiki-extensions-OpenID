...
{{Identical|Trusted site}}',
	...
	'openid-provider-label-other-username' => '{{Related|Openid-provider-label}}',
...
Un mot de passe facultatif de compte peut être ajouté dans votre [[Special:Preferences#mw-prefsection-personal|profil utilisateur]].",
	...
	'openidchoosefull' => 'Votre nom entier ($1)', # Fuzzy
...
Vous ne pourriez pas vous connecter sans un OpenID.",
	...
	'openid-userinfo-update-on-login-label' => 'Mettre à jour les données suivantes depuis OpenID à chaque fois que je me connecte :', # Fuzzy
...
ログインに OpenID が必要です。',
	...
	'openid-provider-label-other-username' => 'あなたの $1 での利用者名を入力してください',
...
En optionaalt Passwuert fir de Benotzerkont kann an Ärem [[Special:Preferences#mw-prefsection-personal|Benotzerprofil]] derbäigesat ginn.",
	...
	'openidfullname' => 'Ganzen Numm', # Fuzzy
	...
	'openidchoosefull' => 'Äre ganzen Numm ($1)', # Fuzzy
